...
export const POPOVER_INPUT =
  "rounded-sm border border-stark-border bg-stark-soft px-2 py-1 text-sm text-primary outline-none focus:border-accent";
...
export function FloatingPopover({
  ...
  return createPortal(
    <div
      ref={elRef}
      className={cn(
        "fixed z-30 flex items-center gap-0.5 rounded-md border border-stark-border bg-stark p-1 shadow-lg",
        className,
      )}
      {...rest}
    >
